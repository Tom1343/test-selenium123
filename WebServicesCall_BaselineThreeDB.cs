...
{
    public static class WebServicesCall_BaselineThreeDB
    {
        private const string _url = "https://power-baselinethree-soap.emea.tst.api.itglo.net/CGI/WS/Codeunit/POWAutoTestingWS?tenant=baselinethree";
