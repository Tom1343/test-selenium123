...
{
    public static class POWER_WMSCommunication_WS_Baseline
    {
        private const string _url = "https://power-baseline-soap.emea.tst.api.itglo.net/CGI/WS/Codeunit/WMSCommunicationWS?tenant=baseline";
