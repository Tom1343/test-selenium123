...
{
    public static class POWER_WMSCommunication_WS_BaselineTWODB
    {
        private const string _url = "https://s-be-ki-bct20n1.itglo.net:7047/CGI/WS/BASELINETWO/Codeunit/WMSCommunicationWS?tenant=baselinetwo";
