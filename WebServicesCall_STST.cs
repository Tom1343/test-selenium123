...
{
    public static class WebServicesCall_STST
    {
        private const string _url = "https://power-stanleystella-soap.emea.tst.api.itglo.net/CGI/WS/STST/Codeunit/POWAutoTestingWS?tenant=stanleystella";
