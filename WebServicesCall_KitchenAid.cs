...
{
    public static class WebServicesCall_KitchenAid
    {
        private const string _url = "https://power-kitchenaid-soap.emea.tst.api.itglo.net/POWER/WS/KA/Codeunit/POWAutoTestingWS?tenant=kitchenaid";
